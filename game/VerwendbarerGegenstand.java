...
public class VerwendbarerGegenstand extends Gegenstand {
	 ...
	 */
	public VerwendbarerGegenstand(String[] namenGegenstand, NumerusGenus numerusGenus, String beschreibung, Effekt effekt, byte einsetzbar){
	 ...
	 *  einsetzbar: gibt an, wo der Gegenstand einsetzbar ist.
	 */
	public VerwendbarerGegenstand(String[] namenGegenstand, NumerusGenus numerusGenus, String beschreibung, Faehigkeit faehigkeit, byte einsetzbar){
	    super(namenGegenstand, numerusGenus, beschreibung);
	...
	public boolean istEinsetzbarKampf(){
		/**switch(einsetzbar){
			case(NURAUSSERHALB): return false;
			case(UEBERALL): return true;
			case(NURKAMPF): return true;
	    }
	    return false;*/
	...
	public boolean istEinsetzbarAusserhalb(){
		/**switch(einsetzbar){
			case(NURAUSSERHALB): return true;
			case(UEBERALL): return true;
			case(NURKAMPF): return false;
	    }
		return false;*/
