...
public class Ort implements Serializable, IPrintable {
	...
	public String getParam(String param) {
		...
		case "anzahlAusg�nge": return Integer.toString(this.getAusgaenge().size());
		case "anzahlGegenst�nde": return Integer.toString(this.gegenstaende.getAlleGegenstaende().length);
	...
	public String[] getParams() {
		...
		params.add("name"); params.add("anzahlAusg�nge"); params.add("anzahlUntersuchbaresObjekt"); params.add("anzahlNichtUntersucht");
		params.add("anzahlGegenst�nde"); params.add("anzahlNPC"); params.add("alleNPCs");
  ...
  /**
	 * Diese Methode gibt alle UntersuchbarenObjekte dieses Orts zur�ck.
	 */
  ...
  /**
	 * Gibt alle NPCs an diesem Ort zur�ck.
	 */
	public NPC[] getNPCs() {
