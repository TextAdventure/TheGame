...
public class RemoveUntersuchbaresObjektAktion extends Aktion {
	 ...
	 */
	public RemoveUntersuchbaresObjektAktion(Ort ort, UntersuchbaresObjekt untersuchbaresObjekt, String meldung) {
		this.ort = ort;
