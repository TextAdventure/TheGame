...
public class AddUntersuchbaresObjektAktion extends Aktion {
	 ...
	 */
	public AddUntersuchbaresObjektAktion(Ort ort, UntersuchbaresObjekt untersuchbaresObjekt, String meldung) {
		this.ort = ort;
